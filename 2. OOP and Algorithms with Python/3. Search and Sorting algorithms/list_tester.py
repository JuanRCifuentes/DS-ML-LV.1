...
def timer(funct):
    def wrapper_function(*Args, **Kwargs):
        time0 = time.time()
        funct(*Args, **Kwargs)
        print(f'La función demoró {time.time() - time0} en correr')
...
def test_all_methods(list_size):
    ...
    print("- " * 55)
    test_list(bubble_sort.bubble_sort, list.copy())
    print("- " * 25)
    test_list(insertion_sort.insertion_sort, list.copy())
    print("- " * 25)
    test_list(merge_sort.merge_sort, list.copy())
    print("- " * 25)
